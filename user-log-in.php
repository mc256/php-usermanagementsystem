...
define("__post_interface_method__",		"remember");
...
define("__remember_filter__", 	"/^(1|0)$/");	//过滤查询的字符串
//
//[[[返回值设定]]]
...
if (isset($_GET[__post_interface_username__])&&
	...
	isset($_GET[__post_interface_method__])) {
	if (preg_match(__username_filter__,$_GET[__post_interface_username__])&&
		...
		preg_match(__remember_filter__,$_GET[__post_interface_method__])) {
		...
		if (confirm_user($_GET[__post_interface_username__],$_GET[__post_interface_password__])) {
			...
			update_login_status($_GET[__post_interface_username__],
								$_GET[__post_interface_password__],
								$_GET[__post_interface_method__]);
